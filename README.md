# Sharlandia — интернет-магазин воздушных шаров

## Описание проекта

**Sharlandia** — это полнофункциональное веб-приложение интернет-магазина по продаже воздушных шаров и праздничных композиций.

Проект разработан в рамках лабораторных работ по дисциплине «Web-технологии» и демонстрирует работу с клиент-серверной архитектурой, базой данных MySQL, REST API и современным frontend-фреймворком React.
...
### Цель
Создание работоспособного веб-приложения для онлайн-магазина воздушных шаров с полным циклом: от просмотра каталога до оформления заказа и управления контентом.

### Задачи
1. Реализовать каталог товаров с фильтрацией
2. Добавить корзину и оформление заказов
3. Создать систему аутентификации пользователей
4. Разработать личный кабинет с историей заказов
5. Создать админ-панель для управления контентом
6. Обеспечить связь с базой данных через REST API

---

## Макет

https://www.figma.com/design/EwT2mRX99An8cuN4A6u9lU/Untitled
...
| Роль | Каталог | Корзина | Профиль | Админ-панель |
|------|---------|---------|---------|--------------|
| Гость | ✅ | ❌ | ❌ | ❌ |
| Пользователь | ✅ | ✅ | ✅ | ❌ |
| Менеджер | ✅ | ✅ | ✅ | Заказы, Товары (CRUD) |
| Админ | ✅ | ✅ | ✅ | Полный доступ (+ удаление товаров, пользователи) |

### Демо-аккаунты

| Роль | Email | Пароль |
|------|-------|--------|
| Админ | `admin@sharlandia.ru` | `admin` |
| Менеджер | `manager@test.ru` | `123` |
| Пользователь | `user@test.ru` | `123` |
...
### Админ-панель
- Управление товарами (CRUD) — только для админа
...
| MySQL с FOREIGN KEY | ✅ |
| Трёхуровневая архитектура | ✅ |
| Сборка без ошибок | ✅ (81 KB JS, 7 KB CSS) |

---

## Ссылки

- **Репозиторий:** локальная папка `C:\xampp\htdocs\sharlandia1\`
- **Макет:** https://www.figma.com/design/EwT2mRX99An8cuN4A6u9lU/Untitled