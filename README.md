...
2. Добавление в корзину → оформление заказа (с контактными данными)
...
1. **Завершение функциональности**
   - Форма оформления заказа с контактными данными (имя, телефон, email)
   - Выбор способа доставки (самовывоз/доставка)
   - Выбор способа оплаты
   - Комментарий к заказу

2. **Обработка ошибок и крайних случаев**
   - Валидация данных при оформлении заказа
   - Обработка пустых состояний корзины
...
- `feat: добавить форму оформления заказа с контактными данными (ЛР-5)` — Завершение функциональности
- `feat: добавить связи между таблицами (FOREIGN KEY)` — Целостность данных
- `refactor: улучшить стили авторизации и профиля` — UI/UX улучшения

---

## 📊 Связи между таблицами (FOREIGN KEY)

После выполнения лабораторной работы таблицы связаны:
...
Это обеспечивает:
- Каскадное удаление заказов при удалении пользователя
- Сохранение целостности данных
- Автоматическую связь товаров с категориями